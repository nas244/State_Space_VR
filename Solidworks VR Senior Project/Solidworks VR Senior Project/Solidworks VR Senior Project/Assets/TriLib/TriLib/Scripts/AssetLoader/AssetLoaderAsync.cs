...
{    /// <summary>
    ...
    public class AssetLoaderAsync : AssetLoaderBase
    {
        ...
        internal void LoadFromFileWithTextures(string filename, object assetLoaderOptions, object p1, Action<GameObject> p2)
        {
            throw new NotImplementedException();
        }

        internal void LoadFromMemoryWithTextures(byte[] fileBytes, string extension, object assetLoaderOptions, object p1, Action<GameObject> p2)
        {
            throw new NotImplementedException();
        }
