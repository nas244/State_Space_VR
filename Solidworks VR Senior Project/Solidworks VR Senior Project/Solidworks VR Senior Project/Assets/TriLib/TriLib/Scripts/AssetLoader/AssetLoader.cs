...
namespace TriLib
{
    ...
    public class AssetLoader : AssetLoaderBase
    {
        ...
        internal GameObject LoadFromFileWithTextures(string filename, object assetLoaderOptions)
        {
            throw new NotImplementedException();
        }

        internal GameObject LoadFromMemoryWithTextures(byte[] fileBytes, string extension, object assetLoaderOptions, GameObject rootGameObject)
        {
            throw new NotImplementedException();
        }
        ...
        /// <param name="basePath">Base path from the loaded file.</param>
        /// <param name="progressCallback">Callback used to retrieve file loading percentage.</param>
        /// <returns><c>true</c> if model was loaded, otherwise <c>false</c>.</returns>
